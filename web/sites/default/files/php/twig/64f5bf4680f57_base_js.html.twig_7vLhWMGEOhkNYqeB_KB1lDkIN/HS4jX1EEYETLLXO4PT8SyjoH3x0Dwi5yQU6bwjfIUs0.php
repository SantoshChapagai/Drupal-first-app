...
class __TwigTemplate_10d2c560363aacda2e579575ec7ee793 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_ad96c2d8979d8d23860453e7c5eb1520->enter($__internal_ad96c2d8979d8d23860453e7c5eb1520_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@webprofiler/Profiler/base_js.html.twig"));

        // line 3
        echo "<script";
        if ((array_key_exists("csp_script_nonce", $context) && ($context["csp_script_nonce"] ?? null))) {
            echo " nonce=\"";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["csp_script_nonce"] ?? null), 3, $this->source), "html", null, true);
            echo "\"";
        }
        echo ">/*<![CDATA[*/
  ";
  ...
  if (typeof Sfjs === 'undefined' || typeof Sfjs.loadToolbar === 'undefined') {
    Sfjs = (function() {
      ...
      var profilerStorageKey = 'drupal/profiler/';
      ...
      ";
        ...
        window.fetch = function () {
          ...
          if (!url.match(new RegExp(";
            // line 312
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(json_encode($this->sandbox->ensureToStringAllowed(($context["excluded_ajax_paths"] ?? null), 312, $this->source)));
            echo "))) {
            var method = 'GET';
      ...
      if (window.XMLHttpRequest && XMLHttpRequest.prototype.addEventListener) {
        ...
        XMLHttpRequest.prototype.open = function(method, url, async, user, pass) {
          ...
          if (url.substr(0, 1) === '/') {
            if (0 === url.indexOf('";
            // line 355
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, true, 355), 355, $this->source), "js"), "html", null, true);
            echo "')) {
              path = url.substr(";
            // line 356
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_length_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, true, 356), 356, $this->source)), "html", null, true);
            echo ");
            }
          }
          else if (0 === url.indexOf('";
            // line 359
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["request"] ?? null), "schemeAndHttpHost", [], "any", false, false, true, 359), 359, $this->source) . $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, true, 359), 359, $this->source)), "js"), "html", null, true);
            echo "')) {
            path = url.substr(";
            // line 360
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_length_filter($this->env, ($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["request"] ?? null), "schemeAndHttpHost", [], "any", false, false, true, 360), 360, $this->source) . $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, true, 360), 360, $this->source))), "html", null, true);
            echo ");
          }

          if (!path.match(new RegExp(";
            // line 363
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(json_encode($this->sandbox->ensureToStringAllowed(($context["excluded_ajax_paths"] ?? null), 363, $this->source)));
            echo "))) {
            var stackElement = {
              error: false,
              url: url,
      ...
      return {
        ...
        showToolbar: function(token) {
          ...
          if (getPreference('toolbar/displayState') == 'none') {
            ...
            /* Added by Drupal */
            document.body.classList.add('webprofiler-closed');
          } else {
            ...
            /* Added by Drupal */
            document.body.classList.add('webprofiler-open');
          }
        },
        ...
        initToolbar: function(token) {
          ...
          addEventListener(hideButton, 'click', function (event) {
            ...
            /* Added by Drupal */
            document.body.classList.remove('webprofiler-open');
            document.body.classList.add('webprofiler-closed');
          });
          ...
          addEventListener(showButton, 'click', function (event) {
            ...
            /* Added by Drupal */
            document.body.classList.add('webprofiler-open');
            document.body.classList.remove('webprofiler-closed');
          });
        },
        ...
        loadToolbar: function(token, newToken) {
          ...
          this.load(
            ...
            '";
        // line 554
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getPath("webprofiler.toolbar", ["token" => "xxxxxx"]), "js"), "html", null, true);
        echo "'.replace(/xxxxxx/, newToken),
            function(xhr, el) {
              ...
              /* Added by Drupal */
              document.body.classList.add('webprofiler');
            },
            function(xhr) {
        ...
        // line 638
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getPath("<front>"), "js"), "html", null, true);
        echo "' + newToken + '>Open the Webprofiler.</a>\\
                                </div>\\
                            ';
...
";
    ...
    {
        return array (  710 => 638,  623 => 554,  459 => 392,  427 => 363,  421 => 360,  417 => 359,  411 => 356,  407 => 355,  361 => 312,  340 => 293,  338 => 292,  51 => 7,  42 => 3,);
    }

    public function getSourceContext()
    {
        return new Source("", "@webprofiler/Profiler/base_js.html.twig", "/app/web/modules/contrib/webprofiler/templates/Profiler/base_js.html.twig");
    }
    ...
    public function checkSecurity()
    {
        ...
        static $functions = array("path" => 554);
